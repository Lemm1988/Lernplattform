...
$template_file = __DIR__ . '/newsletter.html';
$success = '';
$error = '';
$mail_html = '';
        ...
        <div class="col-md-8 col-lg-9">
            <main class="main-content">
                <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="bi bi-envelope-paper me-2"></i>Newsletter bearbeiten & versenden</h1>
                </div>
                <?php if ($error): ?>
                ...
                <form method="post" id="mailForm" autocomplete="off">
                    ...
                    <button type="submit" class="btn btn-primary me-2"><i class="bi bi-save me-1"></i>Speichern</button>
                    <button type="submit" name="send_newsletter" value="1" class="btn btn-success"><i class="bi bi-send me-1"></i>Newsletter versenden</button>
                </form>
                <hr class="my-5">
                <h2>Vorschau</h2>
...
function updatePreview() {
    ...
    html = html.replace(/\{\{USERNAME\}\}/g, 'Max Mustermann'); // Optional für Personalisierung

...
if (!isset($lf9Chapters[$chapterKey])) {
    http_response_code(404);
    exit('Kapitel nicht definiert.');
}

$chapter = $lf9Chapters[$chapterKey];
$page_title = 'LF9 · ' . $chapter['title'];
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <nav aria-label="breadcrumb" class="mb-4">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/Learningfields/LF9/index.php">LF9 Übersicht</a></li>
                        ...
                        <a href="/Learningfields/LF9/index.php" class="btn btn-outline-primary">

...
if (!isset($lf5Chapters[$chapterKey])) {
    http_response_code(404);
    exit('Kapitel nicht definiert.');
}

$chapter = $lf5Chapters[$chapterKey];
$page_title = 'LF5 · ' . $chapter['title'];
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <nav aria-label="breadcrumb" class="mb-4">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/Learningfields/LF5/index.php">LF5 Übersicht</a></li>
                        ...
                        <a href="/Learningfields/LF5/index.php" class="btn btn-outline-primary">

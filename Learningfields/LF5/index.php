...
if (function_exists('check_section_access')) {
    check_section_access('/Learningfields/LF5/index.php');
}
require_once __DIR__ . '/content.php';
$page_title = 'LF5: Datenbanken entwickeln und anpassen';
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <div class="text-center mb-5">
                            <h1 class="mb-3">Lernfeld 5: Datenbanken entwickeln und anpassen</h1>
                            <p class="lead">
                                Diese Lerneinheit vermittelt dir, wie du Datenbanken konzipierst, implementierst,
                                optimierst und an veränderte Anforderungen anpasst.
                            </p>
                        </div>

                        <div class="row g-4">
                            <?php foreach ($lf5Chapters as $key => $chapter): ?>
                                <div class="col-md-6">
                                    <div class="card h-100 shadow-sm">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto">
                                                <a href="/Learningfields/LF5/<?= htmlspecialchars($key) ?>.php" class="btn btn-primary w-100">
                                                    Kapitel öffnen
                                                </a>
                                            </div>
                                        </div>

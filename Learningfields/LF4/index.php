...
$page_title = 'LF4: Benutzerunterstützung und kundenorientierte Kommunikation';
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <div class="text-center mb-5">
                            <h1 class="mb-3">Lernfeld 4: Benutzerunterstützung und kundenorientierte Kommunikation</h1>
                            <p class="lead">
                                Diese Lerneinheit vermittelt dir, wie du Benutzer*innen professionell unterstützt,
                                Probleme löst und durch kundenorientierte Kommunikation und Schulungen einen Mehrwert schaffst.
                            </p>
                        </div>

                        <div class="row g-4">
                            <?php foreach ($lf4Chapters as $key => $chapter): ?>
                                <div class="col-md-6">
                                    <div class="card h-100 shadow-sm">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto">
                                                <a href="/Learningfields/LF4/<?= htmlspecialchars($key) ?>.php" class="btn btn-primary w-100">
                                                    Kapitel öffnen
                                                </a>
                                            </div>
                                        </div>

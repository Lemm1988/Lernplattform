...
if (!isset($lf6Chapters[$chapterKey])) {
    http_response_code(404);
    exit('Kapitel nicht definiert.');
}

$chapter = $lf6Chapters[$chapterKey];
$page_title = 'LF6 · ' . $chapter['title'];
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <nav aria-label="breadcrumb" class="mb-4">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/Learningfields/LF6/index.php">LF6 Übersicht</a></li>
                        ...
                        <a href="/Learningfields/LF6/index.php" class="btn btn-outline-primary">

...
if (function_exists('check_section_access')) {
    check_section_access('/Learningfields/LF10/index.php');
}
require_once __DIR__ . '/content.php';
$page_title = 'LF10: Betreuen von IT-Systemen';
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <div class="text-center mb-5">
                            <h1 class="mb-3">Lernfeld 10: Betreuen von IT-Systemen</h1>
                            <p class="lead">
                                Diese Lerneinheit vermittelt dir, wie du IT-Systeme wartest, überwachst
                                und kontinuierlich optimierst.
                            </p>
                        </div>

                        <div class="row g-4">
                            <?php foreach ($lf10Chapters as $key => $chapter): ?>
                                <div class="col-md-6">
                                    <div class="card h-100 shadow-sm">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto">
                                                <a href="/Learningfields/LF10/<?= htmlspecialchars($key) ?>.php" class="btn btn-primary w-100">
                                                    Kapitel öffnen
                                                </a>
                                            </div>
                                        </div>

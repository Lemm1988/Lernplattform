...
if (!isset($lf10Chapters[$chapterKey])) {
    http_response_code(404);
    exit('Kapitel nicht definiert.');
}

$chapter = $lf10Chapters[$chapterKey];
$page_title = 'LF10 · ' . $chapter['title'];
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <nav aria-label="breadcrumb" class="mb-4">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/Learningfields/LF10/index.php">LF10 Übersicht</a></li>
                        ...
                        <a href="/Learningfields/LF10/index.php" class="btn btn-outline-primary">

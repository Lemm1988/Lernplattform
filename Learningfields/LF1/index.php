...
if (function_exists('check_section_access')) {
    check_section_access('/Learningfields/LF1/index.php');
}
require_once __DIR__ . '/content.php';
$page_title = 'LF1: Unternehmen und eigene Rolle';
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <div class="text-center mb-5">
                            <h1 class="mb-3">Lernfeld 1: Das Unternehmen und die eigene Rolle im Betrieb beschreiben</h1>
                            <p class="lead">
                                Diese Lerneinheit begleitet Auszubildende im ersten Lehrjahr dabei,
                                ihre Aufgaben und die rechtlichen Rahmenbedingungen in ihren Betrieb zu verstehen.
                            </p>
                        </div>

                        <div class="row g-4">
                            <?php foreach ($lf1Chapters as $key => $chapter): ?>
                                <div class="col-md-6">
                                    <div class="card h-100 shadow-sm">
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="mt-auto">
                                                <a href="/Learningfields/LF1/<?= htmlspecialchars($key) ?>.php" class="btn btn-primary w-100">
                                                    Kapitel öffnen
                                                </a>
                                            </div>
                                        </div>

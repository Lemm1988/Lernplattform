...
if (!isset($lf1Chapters[$chapterKey])) {
    http_response_code(404);
    exit('Kapitel nicht definiert.');
}

$chapter = $lf1Chapters[$chapterKey];
$page_title = 'LF1 · ' . $chapter['title'];
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <nav aria-label="breadcrumb" class="mb-4">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/Learningfields/LF1/index.php">LF1 Übersicht</a></li>
                        ...
                        <a href="/Learningfields/LF1/index.php" class="btn btn-outline-primary">

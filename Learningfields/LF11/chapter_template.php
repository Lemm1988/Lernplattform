...
if (!isset($lf11Chapters[$chapterKey])) {
    http_response_code(404);
    exit('Kapitel nicht definiert.');
}

$chapter = $lf11Chapters[$chapterKey];
$page_title = 'LF11 · ' . $chapter['title'];
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9">
                        <nav aria-label="breadcrumb" class="mb-4">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/Learningfields/LF11/index.php">LF11 Übersicht</a></li>
                        ...
                        <a href="/Learningfields/LF11/index.php" class="btn btn-outline-primary">
